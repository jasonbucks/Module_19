...
candidate_database = {
    ...
    #
    # Edited the starter code to use the actual account addresses in my Ganache for indexes 1 through 4
    #
    "Lane": ["Lane", "0x776852185A8Fe9A0DD826964b165677B4226B47d", "4.3", .20, "Images/lane.jpeg"],
    "Ash": ["Ash", "0xab5ef95Bc6A297845d56E23254290f531eB142A3", "5.0", .33, "Images/ash.jpeg"],
    "Jo": ["Jo", "0x85F88DC81faF0Daa80E6bdE8c9Ad31665c6A94dE", "4.7", .19, "Images/jo.jpeg"],
    "Kendall": ["Kendall", "0x03B9D4A46bBf0AE8f6e586FEfc424098e7C18Cb9", "4.1", .16, "Images/kendall.jpeg"]
}
